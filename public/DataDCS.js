...
async function Test(){
  let TestTerm = "202220" //Spring 2022
  let TestCRNs = []
  let TestCustomSections = [
    {
      CRN: "11111",
      Subject: "CUST",
      Code: "BREAK",
  ...
  let TestCourses = [
    {CourseName: "EECE321",
    SeatsFilter: false,
    ProfessorFilter: (await GetProfs(TestTerm, "EECE", "321"))},
    {CourseName: "EECE321L",
    SeatsFilter: false,
    ProfessorFilter: (await GetProfs(TestTerm, "EECE", "321L"))},
    {CourseName: "EECE334",
    SeatsFilter: false,
    ProfessorFilter: (await GetProfs(TestTerm, "EECE", "334"))},
    {CourseName: "EECE338",
    SeatsFilter: false,
    ProfessorFilter: (await GetProfs(TestTerm, "EECE", "338"))},
    {CourseName: "INDE301",
    SeatsFilter: false,
    ProfessorFilter: (await GetProfs(TestTerm, "INDE", "301"))},
    {CourseName: "ENGL206",
    SeatsFilter: false,
    ProfessorFilter: (await GetProfs(TestTerm, "ENGL", "206"))},
    {CourseName: "ENGL212",
    SeatsFilter: false,
    ProfessorFilter: (await GetProfs(TestTerm, "ENGL", "212"))}]//must add all courses here
  
  let Perms = await GetPermutations(TestTerm,TestCRNs,TestCustomSections,TestCourses,800,1515)
}
